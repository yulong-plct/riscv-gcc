...
AVAIL (prefetchr32, TARGET_ZICBOP && !TARGET_64BIT)
AVAIL (prefetchr64, TARGET_ZICBOP && TARGET_64BIT)
AVAIL (prefetchw32, TARGET_ZICBOP && !TARGET_64BIT)
AVAIL (prefetchw64, TARGET_ZICBOP && TARGET_64BIT)
